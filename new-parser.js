...
cmd.run("curl -k -v https://sistemas.anac.gov.br/sas/registros/Futuro/serie/", {onData: (data) => {
    var now = currentTime();
    var date = now.format("YYYY-MM-DD");
    var search = "futuro_"+date+".csv";
    var r = new RegExp("\/" + search + "\/g");//data.match("/"+search+"/g");
    var regex = "/" + date + "/g";
    console.log(data.toString().match(search).length);
    process.exit(1);
}});
...
//cron.schedule(settings.cronString, function() {
    ...
    var hotranFile = "https://sistemas.anac.gov.br/sas/registros/Futuro/serie/futuro_"+currentDate+".csv";
